...
public partial class NetworkedEntityState : Schema
{
	...
	{
		return new NetworkedEntityState() { id = id, ownerId = ownerId, creationId = creationId, xPos = xPos, yPos = yPos, zPos = zPos, xRot = xRot, yRot = yRot, zRot = zRot, wRot =wRot, xVel = xVel, yVel = yVel, attributes = attributes };
	}
}
