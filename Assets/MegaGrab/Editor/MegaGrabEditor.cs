...
/*� � � �*/ return (EditorWindow)Res;
	...
	public override void OnInspectorGUI()
	{
...
#if UNITY_5 || UNITY_6 || UNITY_2017 || UNITY_2018 || UNITY_2019 || UNITY_2020 || UNITY_2021
#else
		...
		//Rect pos1 = new Rect(0, 0, 100, 100);	//gameView.position;

		if ( mg.CalcFromSize )
		{
			mg.CalcUpscale((int)Screen.width, (int)Screen.height);
		}
		else
		{
			mg.GrabWidthWillBe = (int)Screen.width * mg.ResUpscale;
			mg.GrabHeightWillBe = (int)Screen.height * mg.ResUpscale;
		}
